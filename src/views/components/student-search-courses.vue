...
export default {
    ...
    methods: {
        searchCourses: function() {
            ...
            this.axios.get('https://animoapi.herokuapp.com/api/courses/code/' + this.input)
            .then((result)=>{
        ...
        getCourses: function() {
            this.axios.get('https://animoapi.herokuapp.com/api/students/' + this.currentUser + '/courses').then((result)=>{
                console.log(result.data)
        ...
        enlistCourses: function() {
            ...
            if(this.validCourses()){
                this.axios.patch('https://animoapi.herokuapp.com/api/students/' + this.currentUser + '/courses', 
                {
                    action: "ENLIST",
    ...
    created(){
        ...
        this.axios.get('https://animoapi.herokuapp.com/api/students/authenticate-session', {headers:{withCredentials:true}}).then((result) =>{
