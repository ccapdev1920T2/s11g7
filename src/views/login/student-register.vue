...
export default {
    ...
    methods: {
        onSubmit(){
            ...
            this.axios.get('http://animoapi.herokuapp.com/api/students/' + this.idnum).then((result)=>{
                ...
                if(result.data != null){
                    ...
                    this.axios.post('http://animoapi.herokuapp.com/api/students/register', student).then((result) =>{
                        console.log(result)
